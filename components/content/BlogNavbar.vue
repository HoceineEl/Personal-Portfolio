    ...
    <div
      ...
      <ul class="justify-between gap-3 flex items-center">
        <li class="font-semibold text-lg">
          <NuxtLink to="/blog" aria-label="Visit the Blog page" :prefetch="false">Blog</NuxtLink>
        </li>
        <li class="flex gap-3">
          <div>
            <a href="https://github.com/hoceineel" target="_blank" aria-label="Visit GitHub profile"><img :src="github"
                alt="hoceine EL IDRISSI github profile" width="30" loading="lazy" /></a>
          </div>

          <div>
            <a href="https://www.linkedin.com/in/elidrissihoceine/" target="_blank" aria-label="Visit LinkedIn profile">
              <img :src="linkedin" alt="hoceine EL IDRISSI linkedin profile" width="30" loading="lazy" /></a>
          </div>
        </li>
      </ul>
    </div>
