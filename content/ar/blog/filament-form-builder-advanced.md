---
title: "منشئ النماذج المتقدم في FilamentPHP: نماذج ديناميكية وحقول مخصصة"
description: أتقن تقنيات النماذج المتقدمة في FilamentPHP، ومنها الحقول الديناميكية، والمنطق الشرطي، والمكوّنات المخصصة، وحقول التكرار (repeaters)، وأنماط التحقق المعقدة.
tags:
  - FilamentPHP
  - Laravel
  - Forms
...
# منشئ النماذج المتقدم في FilamentPHP: نماذج ديناميكية وحقول مخصصة

منشئ النماذج (form builder) في FilamentPHP قوي جدًا. يتجاوز الحقول الأساسية ليدعم الحقول الديناميكية، والتحقق المعقد، والمكوّنات (components) المخصصة، والمنطق الشرطي المتقدم، وكل ذلك بـ PHP خالص.
...
يتعامل منشئ النماذج في FilamentPHP مع كل شيء، من الحقول البسيطة إلى المعالجات متعددة الخطوات ذات المنطق الشرطي. المفتاح أن تفهم نمط Get/Set للتفاعلية، وأن تستفيد من نظام المكوّنات لإعادة الاستخدام.

أتقن هذه الأنماط، وستبني أي نموذج يحتاجه تطبيقك.

---

## المصادر

- [توثيق نماذج Filament](https://filamentphp.com/docs/4.x/forms)
- [حقول النماذج في Filament](https://filamentphp.com/docs/4.x/forms/fields)
